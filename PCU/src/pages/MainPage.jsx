		...
		<div className='main-page'>
			...
			<section className='hero'>
				...
				<div className='hero-content'>
					...
					<p>
						Мы предлагаем быструю и безопасную доставку ваших посылок в любую
						точку мира. Отслеживайте статус доставки в реальном времени и будьте
						уверены в сохранности вашего груза.
					</p>
			...
			<section id='about' className='about-section'>
				<div className='about-hero'>
					...
					<p>
						Мы - команда профессионалов, которая делает доставку простой и
						надежной
					</p>
				</div>
				<div className='about-content'>
					<div className='mission'>
						<h3>Наша миссия</h3>
						<p>
							Мы стремимся сделать международную доставку доступной, надежной и
							прозрачной для каждого клиента.
						</p>
					</div>
					<div className='stats'>
